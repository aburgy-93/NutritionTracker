...
public class AddSearchedFood extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session != null && sub != null) {
            try {
                // Instantiate the SpoonactularDao
                ...
                logger.debug("Received ID: " + idParam);

                // TODO: What if spoonacular is not working?
                    ...
                    try {
                        ...
                        // Error page could not find product
                    }
            } catch (Exception e) {
        ...
        if (session != null && sub != null) {
            try {
                ...
                if (isNullOrEmptyString(servingsStr) || isNullOrEmptyString(caloriesStr) || isNullOrEmptyString(proteinStr)
                    ...
                    logger.debug("Missing or empty numeric input(s): servings='{}', calories='{}', protein='{}', carbs='{}', fats='{}'",
